...
export const metadata: Metadata = {
  title: "Disclaimer",
  description:
    "PipGlyph is an unofficial custom card design and playtesting tool — read the full disclaimer.",
...
export default function DisclaimerPage() {
  return (
    <LegalPageShell
      eyebrow="Legal"
      title="Disclaimer"
      description="What PipGlyph is — and what it isn't."
    ...
    >
      ...
      <h2>What PipGlyph is</h2>
      <p>
        PipGlyph is an independent, fan-built tool for designing, sharing, and
      ...
      <ul>
        ...
        <li>
          PipGlyph is <strong>not</strong> a substitute for officially
      ...
      <p>
        When you upload artwork or text to PipGlyph, you confirm that you have
      ...
      <p>
        If you believe a card on PipGlyph infringes your rights, please reach
      ...
      <p>
        We may update this page as PipGlyph evolves. The version above will be
