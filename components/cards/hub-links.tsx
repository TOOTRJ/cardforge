...
// Internal links to the browse hubs — rendered under the gallery grid and on
// every hub, so crawlers (and people) can reach each hub from every other
// one. Server component; the counts are ISR-cached with the page.
export async function HubLinks({
  ...
  return (
    <nav aria-label="Browse the gallery by type and tag" className="mt-12 flex flex-col gap-5 border-t border-border/40 pt-8">
      {typeLinks.length > 0 ? (
