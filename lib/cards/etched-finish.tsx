...
// SVG <mask> is luminance by default in both Chromium and resvg (Satori's
// rasteriser), so no mask-mode / mask-type property is needed anywhere.
//
...
export function EtchedSheen({
   ...
   *  preview's frame URL (WebP; the frames bucket sends ACAO *). */
  frameHref: string;
  landscape?: boolean;
  width: number | string;
