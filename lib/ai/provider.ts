 ...
 * flows REQUIRE this (FLUX / Gemini via the gateway; there is no direct-
 * provider image path — they return an error without it). Text flows don't
 * need it (string ids fall back through provider keys).
 */
